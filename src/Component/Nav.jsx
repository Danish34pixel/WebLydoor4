...
const Nav = () => {
  ...
  return (
    <div className="sticky top-0 z-[100] w-full h-[100px] flex items-center px-4 sm:px-8 bg-transparent backdrop-blur-lg">
      ...
      <div
        className={`fixed top-[100px] left-0 w-full h-[calc(100vh-100px)] bg-black border-t border-[#C4F20D]/20 md:hidden overflow-hidden transition-all duration-300 ease-in-out origin-top z-[60] ${isMobileMenuOpen ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0 pointer-events-none'
          }`}
      >
