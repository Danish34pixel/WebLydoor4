    ...
    <div ref={containerRef} className="w-full min-h-screen bg-transparent text-white selection:bg-[#C4F20D] selection:text-black">
      ...
      <main ref={contentRef} className="max-w-7xl mx-auto px-4 sm:px-8 xl:px-12 pt-10 pb-20 relative z-10 transition-all">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-gray-400 font-sans leading-relaxed mb-10 max-w-xl">
              Weblydoor's vision is to be the world's most innovative digital agency, empowering every business to reach its full potential in an ever-evolving digital landscape.
            </p>
          </div>
        ...
        <section className="mt-32 p-12 rounded-[3rem] bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border border-white/5 relative overflow-hidden">
          ...
          <h2 className="text-3xl sm:text-5xl font-['Eurostile'] mb-12">The Digital Horizon</h2>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Leading the charge in AI, Web3, and immersive digital experiences to redefine what's possible online.
              </p>
            </div>
            <div>
              <div className="text-6xl font-extrabold text-[#C4F20D]/20 mb-4 font-['Eurostile']">02</div>
              <h4 className="text-xl font-bold mb-4">Empowerment</h4>
              <p className="text-gray-400 text-sm leading-relaxed">
                Providing businesses of all sizes with the high-end tools and strategies usually reserved for industry giants.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Setting the gold standard for quality, performance, and aesthetic beauty in the digital world.
              </p>
            </div>
          </div>
        </section>
